...
export const Button = ({ children, variant = 'primary', size = 'md', className = '', ...props }) => {
    ...
    const variants = {
        primary: "bg-green-950 text-white hover:bg-green-900 shadow-emerald-950/30",
        ...
        danger: "bg-gradient-to-r from-red-600 to-pink-600 text-white shadow-red-500/30"
    };

    return (
        <button className={`${baseStyle} ${sizes[size] || sizes.md} ${variants[variant]} ${className}`} {...props}>
            {children}
        </button>
    );
};
